...
def _apply_gated_residual_compat(
    ...
    """
    Compat wrapper for transformers versions that do not expose modeling_gemma._gated_residual.
    """
...
class PI05Pytorch(nn.Module):  # see openpi `PI0Pytorch`
    ...
    def embed_prefix(
        ...
        if embs and lang_emb.dtype != embs[0].dtype:
            lang_emb = lang_emb.to(dtype=embs[0].dtype)
